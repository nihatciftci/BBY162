...
<html lang="en" style="height: 100%">
    <head>
        <meta charset="utf-8">
        <title>uygulama04.py : /home/sevinserdar/uygulama04.py : Editor : sevinserdar : PythonAnywhere</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta name="description" content="uygulama04.py : /home/sevinserdar/uygulama04.py : Editor : sevinserdar : PythonAnywhere">
        ...
        <link rel="stylesheet" href="/static/CACHE/css/a5c0829f431b.css" type="text/css" /><link rel="stylesheet" href="/static/CACHE/css/7376f1fe3938.css" type="text/css" media="screen" />

        <!-- Le javascript -->
        <script type="text/javascript">
            var Anywhere = {};
            Anywhere.urls = {};
            Anywhere.csrfToken = "wXmY6xWzKzRNzayeN1c0cqhNIzTLOTQu9dRFkupmzjiNcY2KNSBUlJLI77zVFsLL";
        </script>
        <script type="text/javascript" src="/static/CACHE/js/efd0f9224b4c.js"></script>
        

        <script type="text/javascript" src="/static/CACHE/js/4d5d4f66ed1b.js"></script>
        
    <script type="text/javascript">
      $(document).ready(function() {
        $.extend(Anywhere.urls, {
          file: "/user/sevinserdar/files/home/sevinserdar/uygulama04.py",
          check_hash: "/user/sevinserdar/files/home/sevinserdar/uygulama04.py",
          update_editor_mode_preference: "/user/sevinserdar/account/update_editor_mode_preference",
          console_api: "/api/v0/user/sevinserdar/consoles/",
        });
        var filename = "/home/sevinserdar/uygulama04.py";
        var hash = "f9029984be616178f73ee5d86a1e3ec2";
        var interpreter = "python3.7";
        ...
        Anywhere2.initializeFileSharingOptions(
          ...
          {
            url: "/api/v0/user/sevinserdar/files/sharing/",
            csrfToken: "wXmY6xWzKzRNzayeN1c0cqhNIzTLOTQu9dRFkupmzjiNcY2KNSBUlJLI77zVFsLL",
            path: "/home/sevinserdar/uygulama04.py"
          }
        );
  ...
  <div id="id_editor_toolbar">
    ...
    <div class="pull-left">
      <span id="id_breadcrumbs_div"><a class="breadcrumbs_link breadcrumb_entry" href="/user/sevinserdar/files/">/</a><a class="breadcrumbs_link breadcrumb_entry" href="/user/sevinserdar/files/home">home</a><span class="breadcrumb_entry">/</span><a class="breadcrumbs_link breadcrumb_entry" href="/user/sevinserdar/files/home/sevinserdar">sevinserdar</a><span class="breadcrumb_entry">/</span><wbr><span class="breadcrumb_entry breadcrumb_terminal">uygulama04.py</span></span>
  ...
  <li class=""><a id="id_dashboard_link" href="/user/sevinserdar/">Dashboard</a></li>
  <li class=""><a id="id_consoles_link" href="/user/sevinserdar/consoles/">Consoles</a></li>
  <li class=""><a id="id_files_link" href="/user/sevinserdar/files/home/sevinserdar">Files</a></li>
  <li class=""><a id="id_web_app_link" href="/user/sevinserdar/webapps/">Web</a></li>
  <li class=""><a id="id_tasks_link" href="/user/sevinserdar/tasks_tab/">Tasks</a></li>
  <li class=""><a id="id_databases_link" href="/user/sevinserdar/databases/">Databases</a></li>
...
<li class=""><a href="https://blog.pythonanywhere.com/" class="blog_link">Blog</a></li>
  ...
  <li class=""><a href="/user/sevinserdar/account/" class="account_link">Account</a></li>
  <li class="">
    <form action="/logout/" method="POST">
      <input type='hidden' name='csrfmiddlewaretoken' value='wXmY6xWzKzRNzayeN1c0cqhNIzTLOTQu9dRFkupmzjiNcY2KNSBUlJLI77zVFsLL' />
...
while True:
    ...
    <div class="row">
        <div class="col-md-5 col-md-offset-3 well">
            ...
            2 consoles.  You can
            have more if you
            <a href="/user/sevinserdar/account/">upgrade your account</a>!

            <p>
            Alternatively, if you don't feel like paying us more money, you
            can <a href="/user/sevinserdar/consoles/">kill some consoles on your Consoles page</a>.
        </div>
    </div>
</div>
